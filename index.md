...
features:
  ...
  - title: The Vault (API)
    details: Automated configuration-driven REST API engine with live interactive Swagger/OpenAPI documentation and atomic bulk transactions.
  - title: Enterprise AI SDK
